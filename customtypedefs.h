...
typedef struct {
    ...
    std::vector<int> pieceOrder;  // the vector with the order of the pieces
 ...
 * @param pieceOrder the order of the pieces
...
class PrefixOccurrences4 {
  ...
  public:
    ...
    PrefixOccurrences4(size_t numberOfCharacters,
        ...
        prefixOccurences4 = BitvecIntl4(bwt.size() + 1);
